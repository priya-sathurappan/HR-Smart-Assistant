...
if __name__ == "__main__":
    em = EmployeeManager()
    em.add_employee(EmployeeCreate(name="Lalitha Krishna", manager_id=None, emp_id=em.get_next_emp_id()))
    em.add_employee(EmployeeCreate(name="Karthik Subburaj", manager_id="E001", emp_id=em.get_next_emp_id()))
    em.add_employee(EmployeeCreate(name="Priya Sathurappan", manager_id="E001", emp_id=em.get_next_emp_id()))
